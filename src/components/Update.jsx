    ...
    return (
      ...
      <Form className='create-form'>
        <Form.Field required>
          ...
          <input placeholder='First Name' required value={ firstName } onChange={ (event) => setFirstName(event.target.value) }/> { /* l'oggetto event che passiamo alla funzione contiene tutte le informazioni riguardo l'evento di input, event.target restituisce l'elemento che ha triggerato l'evento, event.target.value restituisce il valore di quell'elemento */ }
        </Form.Field>
      
        <Form.Field required>
          <label>Last Name</label>
          <input placeholder='Last Name' required value={ lastName } onChange={ (event) => setLastName(event.target.value) } />
        </Form.Field>

        <Form.Field required>
          <label>Phone Number</label>
          <input type={'tel'} placeholder='Phone Number' required value={ phone } onChange={ (event) => setPhone(event.target.value) } />
        </Form.Field>
      
        <Form.Field required>
          <label>Email</label>
          <input type={'email'} placeholder='Email' required value={ mail } onChange={ (event) => setMail(event.target.value) } />
        </Form.Field>
